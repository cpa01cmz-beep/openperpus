        ...
        <div className="mx-auto flex w-full max-w-[var(--container)] flex-col gap-2 px-4 py-8 sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-8">
          <p className="flex items-center gap-2">
            {settings.logo_url ? (
              ...
              <span
                className="grid h-9 w-9 place-items-center rounded-[var(--radius-md)] bg-accent text-brand-strong"
                aria-hidden="true"
              >
            ...
            <span>
              <span className="block font-heading text-lg font-bold text-[var(--surface)]">
                {name}
              </span>
              {settings.tagline ? (
                <span className="block text-sm text-brand-soft/80">{settings.tagline}</span>
              ) : null}
            </span>
          </p>
                ...
                return (
                  <li key={key}>
                    <a
                      ...
                      className="grid min-h-[44px] min-w-[44px] place-items-center rounded-[var(--radius-md)] bg-[var(--surface)]/10 transition hover:bg-accent hover:text-brand-strong focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
                    >
            ...
            <ul className="mt-3 space-y-2 text-sm">
              {hours.map((h, i) => {
                ...
                return (
                  <li
                    key={i}
                    className="flex items-center justify-between gap-3 rounded-[var(--radius-md)] bg-[var(--surface)]/5 px-3 py-2"
                  >
