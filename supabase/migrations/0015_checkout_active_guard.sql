-- ============================================================================
-- 0015_checkout_active_guard.sql — cegah double-POST sukses ganda (server idempotency).
-- checkout_loan menolak bila pasangan (book_id, member_id) sudah punya loan
-- aktif (borrowed|overdue): SQLSTATE 25001 -> 409 CONFLICT.
...
BEGIN
  ...
  -- IDEMPOTENCY: satu pasangan (buku, anggota) hanya boleh 1 loan aktif.
  IF EXISTS (
